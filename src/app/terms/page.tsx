        ...
        <div className="mt-8 flex flex-col gap-6 text-[0.9375rem] leading-relaxed text-ink-muted">
          <section>
            ...
            <p>
              ...
              תשלומים בנאמנות עד לאישור העבודה. את התשלומים בפועל מעבד
              PayPal — אנחנו לעולם לא נוגעים בכסף בעצמנו ולא שומרים פרטי
              תשלום.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              בנוסף לעמלת הפלטפורמה, ייתכן ו-PayPal גובה עמלת עיבוד משלה
              על התשלום — זו עמלה של PayPal עצמה, לא של Kept, ותלויה
              בתנאים שלהם.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              בדיקה ידנית על ידי צוות Kept. אנחנו מתחייבים לבדוק ולהגיב
              לכל מחלוקת תוך 48 שעות. שני הצדדים — הפרילנסר והלקוח —
              יכולים להציג את הצד שלהם לפני קבלת החלטה. אין כרגע תהליך
              אוטומטי לפתרון מחלוקות — כל מקרה נבדק לגופו. אנחנו עובדים על
              שיפור התהליך הזה ככל שהשירות גדל.
            </p>
          </section>

          <section>
            <h2 className="mb-2 text-base font-semibold text-ink">
              למה לא מספיק לבקש מקדמה?
            </h2>
            <p>
              מקדמה של 50% מגנה רק מפני אי-תשלום, לא מפני מחלוקת על איכות
              העבודה — ברגע שהכסף עבר, אין עליו יותר שליטה. ב-Kept הסכום
              המלא מוחזק עד לאישור העבודה, כך ששני הצדדים מוגנים גם אם יש
              חילוקי דעות על התוצאה, לא רק אם מישהו לא משלם.
            </p>
          </section>
